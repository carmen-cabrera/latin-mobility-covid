...
```{r}
category <- "rdi"
data_version <- "raw_adjusted_no_imputation_r2"
```
...
tidy_results_o <- map_df(models_o, tidy, .id = "model")
file_tidy_results_o <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_outflows_param_tidy_results_o_', data_version, '.csv')
write.csv(tidy_results_o, file_tidy_results_o, row.names = FALSE)

glance_results_o <- map_df(models_o, glance, .id = "model")
file_glance_results_o <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_outflows_param_glance_results_o_', data_version, '.csv')
...
file_tidy_results_os <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_outflows_param_tidy_results_os_', data_version, '.csv')
write.csv(tidy_results_os, file_tidy_results_os, row.names = FALSE)

glance_results_os <- map_df(models_os, glance, .id = "model")
file_glance_results_os <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_outflows_param_glance_results_os_', data_version, '.csv')
...
file_m3o_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m3o_re_', data_version, '.csv')
write.csv(m3o_re[[1]], file_m3o_re, row.names = FALSE)

file_m3os_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m3os_re_', data_version, '.csv')
write.csv(m3os_re[[1]], file_m3os_re, row.names = FALSE)

###

file_m4o_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m4o_re_', data_version, '.csv')
write.csv(m4o_re[[1]], file_m4o_re, row.names = FALSE)

file_m4os_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m4os_re_', data_version, '.csv')
write.csv(m4os_re[[1]], file_m4os_re, row.names = FALSE)

###

file_m5o_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m5o_re_', data_version, '.csv')
write.csv(m5o_re[[1]], file_m5o_re, row.names = FALSE)

file_m5os_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m5os_re_', data_version, '.csv')
write.csv(m5os_re[[1]], file_m5os_re, row.names = FALSE)

###

file_m6o_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m6o_re_', data_version, '.csv')
write.csv(m6o_re[[1]], file_m6o_re, row.names = FALSE)

file_m6os_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m6os_re_', data_version, '.csv')
write.csv(m6os_re[[1]], file_m6os_re, row.names = FALSE)

###

file_m7o_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m7o_re_', data_version, '.csv')
write.csv(m7o_re[[1]], file_m7o_re, row.names = FALSE)

file_m7os_re <- paste0(wd, '/data/outputs/', country_short, '/mov-analysis/by-', category, '/data_trend_param_quad_m7os_re_', data_version, '.csv')
