...
%DIF DEL /your/path/to/local/manuscript/original/main.tex   Thu Dec 18 17:13:03 2025
%DIF ADD /your/path/to/local/manuscript/r1/main-r1.tex      Thu Dec 18 21:03:00 2025
...
\begin{figure}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figures/Fig-summary-diagram.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{figures/Fig-summary-diagram-r1.png}
...
\begin{figure}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figures/Fig-impact-design.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{figures/Fig-impact-design-r1.png}
...
%DIF <  \begin{figure}[h!]
%DIF <  \centering
%DIF <  \includegraphics[width=0.8\linewidth]{figures/Fig-recovery-combined-design.png}
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{figures/Fig-re-combined-design-quad-recovery-time-std-r1.png}
...
\begin{figure}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figures/Fig-fuas-netflows-simpler-no-baseline.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figures/Fig-fuas-netflows-simpler-no-baseline-r1.png}
...
\begin{figure}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figures/workflow-diagram.png}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Workflow diagram for data imputation method.}}
%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figures/workflow-diagram-r1.png}
