...
%DIF DEL /Users/carmen/Library/CloudStorage/OneDrive-TheUniversityofLiverpool/research/paper-submissions/2025/latin-mobility-covid/nature-communications/original/SI.tex   Thu Dec 18 17:25:04 2025
%DIF ADD /Users/carmen/Library/CloudStorage/OneDrive-TheUniversityofLiverpool/research/paper-submissions/2025/latin-mobility-covid/nature-communications/r1/SI-r1.tex      Thu Dec 18 21:03:04 2025
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/missing/SF-missing-data-table.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/missing/SF-missing-data-table-r1.png}
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/categories/SF-maps-classes-r1.png}
...
\begin{figure}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/categories/SF-classes-combined.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/categories/SF-classes-bias-r1.png}
...
\begin{figure}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/time-series/Fig-recovery-combined-design.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\linewidth]{supplementary/time-series/Fig-recovery-combined-design-r1.png}
...
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\linewidth]{supplementary/trend-extraction/trend-extraction-robustness-r1.png}
...
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-new-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-stringenty-new-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-new-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-stringency-new-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/models-tables/models-table-COL-quadratic-new-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/models-tables/models-table-COL-quadratic-stringency-new-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-capital.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-capital-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-capital-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-capital-stringency-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-capital.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-capital-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-capital-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-capital-stringency-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-capital.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-capital-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-capital-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-capital-stringency-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-fuas.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-fuas-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-fuas-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-ARG-quadratic-fuas-stringency-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-fuas.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-fuas-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-fuas-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-CHL-quadratic-fuas-stringency-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-fuas.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-fuas-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-fuas-stringency.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{supplementary/models-tables/models-table-COL-quadratic-fuas-stringency-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-std-density.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-std-density-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-std-rdi.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-std-rdi-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-capital-std.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-capital-std-r1.png}
...
\begin{table}[h!]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-fuas-std.png}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{supplementary/recovery-times/recovery-thresholds-table-quadratic-fuas-std-r1.png}
